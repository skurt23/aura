...
export default {
    ...
    created(){
        fetch('https://cors-anywhere.herokuapp.com/http://api.meetup.com/'+MeetupAPI.urlname+'/events?desc=true&photo-host=public&page=4&status=past').then(data=>data.json()).then(res=>{
